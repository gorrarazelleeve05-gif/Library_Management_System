...
const ConditionBadge: React.FC<{ condition: 'good' | 'minor_damage' | 'damaged' | null }> = ({ condition }) => {
  ...
  const styles = {
    good: { bg: '#22c55e22', border: '#22c55e44', color: '#22c55e', label: 'Good' },
    minor_damage: { bg: '#f59e0b22', border: '#f59e0b44', color: '#f59e0b', label: 'Minor Damage' },
    damaged: { bg: '#ef444422', border: '#ef444444', color: '#ef4444', label: 'Damaged' },
  };
    ...
    <div className="page">
      ...
      <div className="toolbar">
        ...
        <button
          ...
          style={{
            background: statusFilter === 'returned' ? '#22c55e' : 'var(--bg-card)',
            color: statusFilter === 'returned' ? 'white' : 'var(--text-primary)',
            border: statusFilter === 'returned' ? '1px solid #16a34a' : '1px solid var(--border)',
        ...
        <button
          ...
          style={{
            background: statusFilter === 'damaged' ? '#ef4444' : 'var(--bg-card)',
            color: statusFilter === 'damaged' ? 'white' : 'var(--text-primary)',
            border: statusFilter === 'damaged' ? '1px solid #dc2626' : '1px solid var(--border)',
